...
public class PruebaBean implements Serializable {  
    ...
    public void savePerson(ActionEvent actionEvent) {  
        ...
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("Bienvenido " + firstname + " " + surname + "!"));
    	}else{
    		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("Error al registrar Usuario  " + firstname + " " + surname + "!"));	
    	}
    }  
} 
